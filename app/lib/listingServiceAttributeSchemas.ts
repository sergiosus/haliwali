...
export const SERVICE_CATEGORY_NAME_TO_SCHEMA_ID: Readonly<Record<string, ListingServiceSchemaId>> = {
  ...
  "подбор запчастей": "service_generic",
  "поиск запчастей по VIN": "service_generic",
  "поиск авто": "service_generic",
  "осмотр авто перед покупкой": "service_generic",
  "проверка объявления": "service_generic",
  "фотоотчёт на месте": "service_generic",
  автопоручения: "service_generic",
  "помощь в покупке авто": "service_generic",
  "доставка мелких запчастей": "service_delivery",
