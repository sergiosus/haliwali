...
import type { Listing, TaskListing } from "../../lib/listings";
...
export default function PostTaskPage() {
  ...
  async function addTask(
    form: {
      title: string;
      description: string;
      categoryName: (typeof taskCategories)[number];
      city: string;
      address?: string;
      latitude?: number;
      longitude?: number;
    ...
    // Duplicate protection: if this token already exists, don't add again.
        ...
        <main className="py-6 pb-16 md:py-8">
          <div className="mx-auto w-full max-w-[1150px]">
            <div className="rounded-xl border border-gray-200 bg-white p-5 md:p-6">
              <div className="text-lg font-medium md:text-xl">Разместить задачу</div>
...
function TaskPostForm({
  ...
  useListingTransferPrefillEffect({
    ...
    defaultCategory: taskCategories[0],
    currentCategory: categoryName,
    onCategoryMatch: (matched) => setCategoryName(matched as (typeof taskCategories)[number]),
  });
